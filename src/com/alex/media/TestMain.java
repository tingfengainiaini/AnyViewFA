...
public class TestMain extends TabActivity implements TabHost.TabContentFactory{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		th.addTab(th.newTabSpec("list").setIndicator("所有歌曲", res.getDrawable(android.R.drawable.stat_sys_download)).setContent(this));
		th.addTab(th.newTabSpec("artists").setIndicator("音乐家", res.getDrawable(android.R.drawable.ic_btn_speak_now)).setContent(this));
		th.addTab(th.newTabSpec("albums").setIndicator("专辑", res.getDrawable(android.R.drawable.btn_star)).setContent(this));
	...
	public View createTabContent(String tag) {
		...
		if (tag.equals("list")){
		    ...
		    listview.setOnCreateContextMenuListener(new ContextMenuListener());//长按
		} 
		//音乐家
		else if (tag.equals("artists")){
			//用android自带的spl类存储歌曲信息
